  ...
  _createClass(WebPushCryptographer, [{
    ...
    value: function encrypt(salt, plaintext, paddingBytes) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this.deriveEncryptionKeys(salt);
      }).then(function (_ref3) {
    ...
    value: function deriveEncryptionKeys(salt) {
      ...
      return Promise.resolve().then(function () {
        ...
        var contentEncryptionKeyInfo = _this2.deriveInfo('aesgcm', senderPublic, receiverPublic);
        var nonceInfo = _this2.deriveInfo('nonce', senderPublic, receiverPublic);
        ...
        var hkdf = new HKDF(ikm, _this2.authSecret_);
